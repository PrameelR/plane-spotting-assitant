...
{
    public partial class PlaneMake
    {
        public PlaneMake()
        {
            PlaneMakesLogs = new HashSet<PlaneMakesLog>();
            PlaneModels = new HashSet<PlaneModel>();
        ...
        public virtual ICollection<PlaneMakesLog> PlaneMakesLogs { get; set; }
